...
test("borrow 2", succTest(expr, `&&a`))
test("borrow 3", succTest(expr, `&&&a`))
test("borrow 4", succTest(expr, `&&&&a`))
test("borrow 5", succTest(expr, `&mut a`))
test("borrow 6", succTest(expr, `&&mut a`))
test("borrow 7", succTest(expr, `&mut&mut a`))
test("borrow 8", succTest(expr, `&&&mut a`))
test("borrow 9", succTest(expr, `&mut&&mut a`))
test("borrow 10", succTest(expr, `&&mut&&a`))
test("borrow 11", succTest(expr, `&mut&&mut&a`))